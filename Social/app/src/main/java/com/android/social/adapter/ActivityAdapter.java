...
public class ActivityAdapter extends RecyclerView.Adapter<ActivityAdapter.ActivityViewHolder> implements ActivityViewInterface {
    ...
    public void onBindViewHolder(@NonNull ActivityViewHolder holder, int position) {
        ...
        if (activityEntityArrayList.get(position).getAccept_username() == 1) {
            ...
            activityPresenter.setButtonClickable(false);
            activityPresenter.setButtonCollor(R.color.colorIII,false);
        }
    ...
    @Override
    public void updateButtonColor( int colorId ) {
        activityPresenter.setButtonCollor(R.color.colorIII,false);
